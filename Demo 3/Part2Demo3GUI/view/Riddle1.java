			...
			public void handle(ActionEvent e1) {						
				if (txtField.getText().toUpperCase().equals("A JOKE")) {
					resultLab.setText("DJ: 'Nice job pal you got it correct! You can call \n "+
							          "me Disco Joe then! Let me tell you, \n" +
								      "I was there that night everything went down. To be honest,\n " +
								      "I don't remember much. I \n" +
								      "didnt notice the one dude hitting the other dude \n" +
								      "because they were going at it to the \n" + 
								      "beat of the jam that was playing. I thought it was some sort of \n" +
								      "new dance move! I do remember \n" +
